...
export function RichTextEditor({ field, sendButton, footerLeft }: iAppProps) {
  ...
  return (
    <div className="relative w-full border border-input rounded-lg over-flow-hidden dark:bg-input/30 flex flex-col">
      <MenuBar editor={editor} />
      <EditorContent editor={editor} className="max-h-[200px] overflow-auto" />
